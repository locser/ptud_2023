 ...
 * @author ploc2
 */
public class QuanLyToa_JPanel extends javax.swing.JFrame {
...
//        private String maTauHienTai = "";
     ...
     */
    public QuanLyToa_JPanel(TauEntity tau) {
        tauHienTai = tau;
        toa_dao = new Toa_dao();
        ...
        lbl_TenTau.setText("Mã: " + tauHienTai.getMaTau() + " - Tên tàu: " + tauHienTai.getTenTau());
